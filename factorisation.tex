...
ayant les mêmes  coefficients $b_i$ pour tout~$i$ sont  équivalentes pour $\sim$
...
De plus, les conditions que l'on s'est donné pour appliquer les règles
...
ou bien sur la même diagonale. Ainsi, dans les cas ``faciles'' tels que $493$,
