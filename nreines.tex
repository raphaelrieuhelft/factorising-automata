...
\begin{figure}[hbt]
  ...
  \resizebox{.7\textwidth}{!}{
    \begin{tikzpicture}[line cap=round,line join=round,>=triangle
      ...
      % (-3.7,0) -- (-3.7,2) -- cycle;
      \draw [color=zzttqq] (0,2)-- (0,0); \draw [color=zzttqq] (0,0)-- (2,0);
      \draw [color=zzttqq] (2,0)-- (2,2); \draw [color=zzttqq] (2,2)-- (0,2);
      \draw [color=zzttqq] (2,2)-- (2,0); \draw [color=zzttqq] (2,0)-- (4,0);
      \draw [color=zzttqq] (4,0)-- (4,2); \draw [color=zzttqq] (4,2)-- (2,2);
      \draw [->] (0,2) -- (0.5,1.48); \draw [->] (0,1) -- (0.5,1); \draw [->]
      (2,1) -- (2.5,1); \draw (1.02,-0.14) node[anchor=north west] {1}; \draw
      (2.94,-0.14) node[anchor=north west] {2}; \draw [color=zzttqq] (-7.7,2)--
      (-7.7,0); \draw [color=zzttqq] (-7.7,0)-- (-5.7,0); \draw [color=zzttqq]
      (-5.7,0)-- (-5.7,2); \draw [color=zzttqq] (-5.7,2)-- (-7.7,2); \draw
      [color=zzttqq] (-5.7,2)-- (-5.7,0); \draw [color=zzttqq] (-5.7,0)--
      (-3.7,0); \draw [color=zzttqq] (-3.7,0)-- (-3.7,2); \draw [color=zzttqq]
      (-3.7,2)-- (-5.7,2); \draw [->] (-7.7,2) -- (-7.2,1.5); \draw [->] (-7.7,1)
      -- (-7.2,1); \draw [->,dash pattern=on 1pt off 1pt] (-3.1,0.98) --
      (-0.58,1); \draw (-6.94,-0.22) node[anchor=north west] {1}; \draw
      (-4.66,-0.2) node[anchor=north west] {2};
    \end{tikzpicture}
  }
